    ...
    <nav id="nav">
        <ul>  
            ...
            <li><form action="testandoUmaTelaPrincipal.jsp" method="post">
                    <input type="submit" class="submitInserirLivro" name="acao" value="principal">
                </form></li> 
            <li><form action="testandoListar.jsp" method="post">
                    <input type="submit" class="submitInserirLivro" name="acao" value="Gerenciar Livros">
                </form></li>       
            ...
            <form id="formInserirLivro" action="CriarUpload" method="post" enctype="multipart/form-data">
                ...
                <table>
                    <tr>
                        ...
                        <td><label id="texto">Selecione Uma foto para o livro :</label></td>
