                ...
                <div id="box-inputs">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="inputResultadoPesquisa" placeholder="Descrição" required="required" name="txtDescricao" value="<%=p.getDescricao()%>"><label id="TextoConsultarLivro">Descrição</label> </td>   
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="inputResultadoPesquisa" placeholder="Sinopse" required="required" name="txtSinopse" value=<%=p.getSinopse()%>><label id="TextoConsultarLivro">Sinopse</label> </td>   
                            <td></td>
                        </tr>
